...
if($('#scorm-frame').length){
  $('<div class="text-center" style="color:black; padding-left:5px; font-size:16px; background-color: #881825;      color:white">If you are seeing a blank screen in your module, please refer to this <a href="https://supportedemployment.freshdesk.com/support/solutions/articles/73000566955-if-your-module-is-displaying-as-a-blank-screen" target="_blank" style="color:white; text-decoration:underline"> article</a> or submit a <a href="https://supportedemployment.freshdesk.com/support/tickets/new" target="_blank" style="color:white; text-decoration:underline">help ticket</a> or reach out to CASE for support: <a style="color:white; text-decoration:underline" href="mailto:albert@supportedemployment.ca?subject=Blank%20screen%20for%20module">albert@supportedemployment.ca</a></div>').appendTo($('.readability'));
}
